...
class CMGBaseline:
    ...
    def _predict(self, preprocessed_commit_mods: str, **kwargs) -> str:
        return self._backbone.generate_msg(preprocessed_commit_mods, **kwargs)

    def generate_msg(self, commit_mods: CommitMods, **kwargs) -> str:
        ...
        commit_msg = self._predict(preprocessed_mods, **predict_kwargs)
        return commit_msg
