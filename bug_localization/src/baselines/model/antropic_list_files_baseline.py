...
class AntropicListFilesBaseline(Baseline):
    ...
    def localize_bugs(self, issue_description: str, repo_content: dict[str, str]) -> Dict[str, Any]:
        ...
        for project_files in batched_project_files:
            ...
            completion = client.messages.create(
                max_tokens=1000,
                system="You are python java and kotlin developer or "
...
def main():
    load_dotenv()
    baseline = AntropicListFilesBaseline('claude-2.0', 'anthropic-claude', 1000000)
